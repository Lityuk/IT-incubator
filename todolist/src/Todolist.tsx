...
import {IdependedButton} from "./components/IdependedButton";
...
export function Todolist(props: PropsType) {
    // const [title, setTitle] = useState(""); (старый превоначальный)
    ...
    return (
        <div>
            ...
            <IdependedButton name = {'+'} callBack={onClickHandlerForInd}/>
